...
6. The recording is exported to a document provider with the specified metadata. Each time you record a new word, a new record is added to a 

Tricks
-----
1. Each word in the wordlist must be distinguished by using some special character like a hyphen or a newline. The default is set to a newline so that the algorithm splits them up line-by-line. You can change it to any custom character.
